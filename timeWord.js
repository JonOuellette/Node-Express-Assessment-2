function timeWord(time) {
    ...
    const minuteToWords = {
        '00': 'o\'clock', '01': 'oh one', '02': 'oh two', '03': 'oh three', '04': 'oh four', 
    ...
    if (hours === '00' && minutes === '00') {
        ...
        const hourWord = hourToWords[hours];
        const minuteWord = minuteToWords[minutes];
        const amPm = parseInt(hours, 10) < 12 ? 'am' : 'pm';

        return minuteWord === 'o\'clock' ? `${hourWord} ${minuteWord} ${amPm}` : `${hourWord} ${minuteWord} ${amPm}`;
    }
}
